      ...
      <div class="container px-0">
        ...
        <div class="footer-nav position-relative">
          <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
            <li class="active"><a href="{{url('mobile/index')}}">
            ...
            <li><a href="{{url('user_profil')}}">
                ...
                <li><a href="{{url('logout')}}" onclick="window.close()">
                    <svg class="bi bi-box-arrow-right" width="20" height="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
